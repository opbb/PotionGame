...
public class UIController : MonoBehaviour
{
    ...
    // Prep stations (These are weird because they're nested within PlayerInventory)
    ...
    void Start()
    {
        ...
        if (playerInventory == null || questManager == null || recipeManager == null || mortarAndPestle == null)
        {
